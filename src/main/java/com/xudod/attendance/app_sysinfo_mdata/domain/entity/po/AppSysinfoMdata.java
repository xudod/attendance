package com.xudod.attendance.app_sysinfo_mdata.domain.entity.po;
...
@ApiModel(value = "系统信息管理")
public class AppSysinfoMdata {
    @ApiModelProperty(example = "id", position = 1)
    private String id;

    @ApiModelProperty(example = "系统名称", position = 2)
    private String name;

    @ApiModelProperty(example = "简称", position = 3)
    private String shortName;

    @ApiModelProperty(example = "编码", position = 4)
    private String code;

    @ApiModelProperty(example = "上线时间", position = 5)
    private String onlineTime;

    @ApiModelProperty(example = "可配属性", position = 6)
    private String configStatus;

    @ApiModelProperty(example = "登录地址", position = 7)
