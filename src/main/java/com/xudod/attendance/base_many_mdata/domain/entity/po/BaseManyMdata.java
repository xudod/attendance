package com.xudod.attendance.base_many_mdata.domain.entity.po;
...
@ApiModel(value = "多键值码表数据")
public class BaseManyMdata {
    ...
    @ApiModelProperty(example = "所在组id", position = 3)
    private String groupCode;

    @ApiModelProperty(example = "编码", position = 4)
    private String code;

    @ApiModelProperty(example = "编码值", position = 5)
