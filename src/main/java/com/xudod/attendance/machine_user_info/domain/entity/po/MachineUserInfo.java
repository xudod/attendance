package com.xudod.attendance.machine_user_info.domain.entity.po;
...
public class MachineUserInfo {
    ...
    @ApiModelProperty(example = "姓名", position = 2)
    private String name;

    @ApiModelProperty(example = "密码", position = 3)
    private String password;

    @ApiModelProperty(example = "权限级别", position = 4)
    private String priviLege;

    @ApiModelProperty(example = "主数据编码", position = 5)
    private String empMdmCode;

    @ApiModelProperty(example = "考勤机编码", position = 6)
    private String machineCode;

    @ApiModelProperty(example = "是否考勤", position = 7)
    private String noNeedAtt;

    @ApiModelProperty(example = "手机打卡", position = 8)
    private String phoneAbleAtt;
    ...
    /**
     * 是否考勤
     * @return no_need_att 是否考勤
     */
    public String getNoNeedAtt() {
        return noNeedAtt;
    }

    /**
     * 是否考勤
     * @param noNeedAtt 是否考勤
     */
    public void setNoNeedAtt(String noNeedAtt) {
        this.noNeedAtt = noNeedAtt;
    }

    /**
     * 手机打卡
     * @return phone_able_att 手机打卡
     */
    public String getPhoneAbleAtt() {
        return phoneAbleAtt;
    }

    /**
     * 手机打卡
     * @param phoneAbleAtt 手机打卡
     */
    public void setPhoneAbleAtt(String phoneAbleAtt) {
        this.phoneAbleAtt = phoneAbleAtt;
    }
