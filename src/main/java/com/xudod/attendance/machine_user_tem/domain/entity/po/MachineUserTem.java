package com.xudod.attendance.machine_user_tem.domain.entity.po;
...
public class MachineUserTem {
    ...
    @ApiModelProperty(example = "设备编码", position = 3)
    private Integer machineCode;

    @ApiModelProperty(example = "指纹编码", position = 4)
    private Integer fingerIndex;

    @ApiModelProperty(example = "指纹信息", position = 5)
    private String tmpData;

    @ApiModelProperty(example = "指纹长度", position = 6)
    private Integer tmpLength;

    @ApiModelProperty(example = "姓名", position = 7)
    private String name;
