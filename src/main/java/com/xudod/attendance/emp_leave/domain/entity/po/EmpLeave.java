package com.xudod.attendance.emp_leave.domain.entity.po;
...
@ApiModel(value = "员工请假表，数据从bpm来")
public class EmpLeave {
    @ApiModelProperty(example = "id", position = 1)
    private String id;

    @ApiModelProperty(example = "请假名称", position = 2)
    ...
    @ApiModelProperty(example = "请假日期", position = 5)
    private String leaveDate;

    @ApiModelProperty(example = "请假状态", position = 6)
    ...
    @ApiModelProperty(example = "请假内容", position = 9)
