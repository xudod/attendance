package com.xudod.attendance.att_confirm_rec.domain.entity.po;
...
@ApiModel(value = "该表考勤数据在人员确认考勤时，其数据与报表是一致的。因为要记录确认考勤当时的状态，所以，要留一个备份。")
public class AttConfirmRec {
    ...
    @ApiModelProperty(example = "考勤确认", position = 3)
    private String isAttConfirm;

    @ApiModelProperty(example = "年", position = 4)
    private String year;

    @ApiModelProperty(example = "月", position = 5)
    private String month;

    @ApiModelProperty(example = "岗位名称", position = 6)
    private String positionTitle;

    @ApiModelProperty(example = "标准职级", position = 7)
    private String standardRank;

    @ApiModelProperty(example = "出勤天数", position = 8)
    private String attDay;

    @ApiModelProperty(example = "休息天数", position = 9)
    private String restDay;

    @ApiModelProperty(example = "迟到早退次数", position = 10)
    private String tenMinTimesIn;

    @ApiModelProperty(example = "旷工次数", position = 11)
    private String tenMinTimesOut;

    @ApiModelProperty(example = "缺卡数", position = 12)
    private String lackAttTimes;

    @ApiModelProperty(example = "缺勤天数", position = 13)
    private String absence;

    @ApiModelProperty(example = "1", position = 14)
    private String att1;

    @ApiModelProperty(example = "2", position = 15)
    private String att2;

    @ApiModelProperty(example = "3", position = 16)
    private String att3;

    @ApiModelProperty(example = "4", position = 17)
    private String att4;

    @ApiModelProperty(example = "5", position = 18)
    private String att5;

    @ApiModelProperty(example = "6", position = 19)
    private String att6;

    @ApiModelProperty(example = "7", position = 20)
    private String att7;

    @ApiModelProperty(example = "8", position = 21)
    private String att8;

    @ApiModelProperty(example = "9", position = 22)
    private String att9;

    @ApiModelProperty(example = "10", position = 23)
    private String att10;

    @ApiModelProperty(example = "11", position = 24)
    private String att11;

    @ApiModelProperty(example = "12", position = 25)
    private String att12;

    @ApiModelProperty(example = "13", position = 26)
    private String att13;

    @ApiModelProperty(example = "14", position = 27)
    private String att14;

    @ApiModelProperty(example = "15", position = 28)
    private String att15;

    @ApiModelProperty(example = "16", position = 29)
    private String att16;

    @ApiModelProperty(example = "17", position = 30)
    private String att17;

    @ApiModelProperty(example = "18", position = 31)
    private String att18;

    @ApiModelProperty(example = "19", position = 32)
    private String att19;

    @ApiModelProperty(example = "20", position = 33)
    private String att20;

    @ApiModelProperty(example = "21", position = 34)
    private String att21;

    @ApiModelProperty(example = "22", position = 35)
    private String att22;

    @ApiModelProperty(example = "23", position = 36)
    private String att23;

    @ApiModelProperty(example = "24", position = 37)
    private String att24;

    @ApiModelProperty(example = "25", position = 38)
    private String att25;

    @ApiModelProperty(example = "26", position = 39)
    private String att26;

    @ApiModelProperty(example = "27", position = 40)
    private String att27;

    @ApiModelProperty(example = "28", position = 41)
    private String att28;

    @ApiModelProperty(example = "29", position = 42)
    private String att29;

    @ApiModelProperty(example = "30", position = 43)
    private String att30;

    @ApiModelProperty(example = "31", position = 44)
    private String att31;

    @ApiModelProperty(example = "员工姓名", position = 45)
    private String empName;

    @ApiModelProperty(example = "因忘打卡补卡次数", position = 46)
    private String forgateAttAddTimes;

    @ApiModelProperty(example = "婚假", position = 47)
    private String leaveTypeHun;

    @ApiModelProperty(example = "事假", position = 48)
    private String leaveTypeShi;

    @ApiModelProperty(example = "年假", position = 49)
    private String leaveTypeNian;

    @ApiModelProperty(example = "调休", position = 50)
    private String leaveTypeTiao;

    @ApiModelProperty(example = "病假", position = 51)
    private String leaveTypeBing;

    @ApiModelProperty(example = "调休假", position = 52)
    private String leaveTypeTiaoxiu;

    @ApiModelProperty(example = "产检假", position = 53)
    private String leaveTypeChanjian;

    @ApiModelProperty(example = "分娩假", position = 54)
    private String leaveTypeFenmian;

    @ApiModelProperty(example = "陪产假", position = 55)
    private String leaveTypePeichan;

    @ApiModelProperty(example = "其他", position = 56)
    private String leaveTypeQita;

    @ApiModelProperty(example = "丧假", position = 57)
    private String leaveTypeSang;

    @ApiModelProperty(example = "工伤假", position = 58)
    private String leaveTypeGongshang;

    @ApiModelProperty(example = "哺乳假", position = 59)
    ...
    /**
     * 考勤确认
     * @return is_att_confirm 考勤确认
     */
    public String getIsAttConfirm() {
        return isAttConfirm;
    }

    /**
     * 考勤确认
     * @param isAttConfirm 考勤确认
     */
    public void setIsAttConfirm(String isAttConfirm) {
        this.isAttConfirm = isAttConfirm;
    }
