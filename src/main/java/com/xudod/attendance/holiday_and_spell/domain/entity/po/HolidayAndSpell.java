package com.xudod.attendance.holiday_and_spell.domain.entity.po;
...
@ApiModel(value = "国家法定节假日和调班信息表")
public class HolidayAndSpell {
    @ApiModelProperty(example = "id", position = 1)
    private String id;

    @ApiModelProperty(example = "状态", position = 2)
    private Integer hStatus;

    @ApiModelProperty(example = "日期", position = 3)
    private String holiorspellDate;

    @ApiModelProperty(example = "中文名称", position = 4)
    private String daynameCn;

    @ApiModelProperty(example = "英文名称", position = 5)
    ...
    /**
     * 日期
     * @return holiorspell_date 日期
     */
    public String getHoliorspellDate() {
        return holiorspellDate;
    }

    /**
     * 日期
     * @param holiorspellDate 日期
     */
    public void setHoliorspellDate(String holiorspellDate) {
        this.holiorspellDate = holiorspellDate;
    }

    /**
     * 中文名称
     * @return dayname_cn 中文名称
     */
    public String getDaynameCn() {
        return daynameCn;
    }

    /**
     * 中文名称
     * @param daynameCn 中文名称
     */
    public void setDaynameCn(String daynameCn) {
        this.daynameCn = daynameCn;
    }

    /**
     * 英文名称
     * @return dayname_en 英文名称
     */
