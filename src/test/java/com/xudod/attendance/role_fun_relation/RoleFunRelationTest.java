package com.xudod.attendance.role_fun_relation;
...
public class RoleFunRelationTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/roleFunRelation/", port);
    ...
    @Test
    public void a_add() {
    	RoleFunRelation roleFunRelation = new RoleFunRelation();
    	roleFunRelation.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), roleFunRelation, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	RoleFunRelation userAttAppInfoVo = new RoleFunRelation();
    ...
    public void e_getpage() {
    	PageParameter<RoleFunRelation> pageParameter = new PageParameter<RoleFunRelation>();
