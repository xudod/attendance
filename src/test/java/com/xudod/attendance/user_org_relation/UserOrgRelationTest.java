package com.xudod.attendance.user_org_relation;
...
public class UserOrgRelationTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/userOrgRelation/", port);
    ...
    public void a_add() {
    	...
    	userOrgRelation.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), userOrgRelation, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	UserOrgRelation userAttAppInfoVo = new UserOrgRelation();
    ...
    public void e_getpage() {
    	PageParameter<UserOrgRelation> pageParameter = new PageParameter<UserOrgRelation>();
