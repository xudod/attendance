package com.xudod.attendance.org_indeustry_relation;
...
public class OrgIndeustryRelationTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/orgIndeustryRelation/", port);
    ...
    @Test
    public void a_add() {
    	OrgIndeustryRelation orgIndeustryRelation = new OrgIndeustryRelation();
    	orgIndeustryRelation.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), orgIndeustryRelation, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	OrgIndeustryRelation userAttAppInfoVo = new OrgIndeustryRelation();
    ...
    public void e_getpage() {
    	PageParameter<OrgIndeustryRelation> pageParameter = new PageParameter<OrgIndeustryRelation>();
