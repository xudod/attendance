package com.xudod.attendance.user_role_relation;
...
public class UserRoleRelationTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/userRoleRelation/", port);
    ...
    public void a_add() {
    	...
    	userRoleRelation.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), userRoleRelation, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	UserRoleRelation userAttAppInfoVo = new UserRoleRelation();
    ...
    public void e_getpage() {
    	PageParameter<UserRoleRelation> pageParameter = new PageParameter<UserRoleRelation>();
