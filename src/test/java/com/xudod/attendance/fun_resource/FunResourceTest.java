package com.xudod.attendance.fun_resource;
...
public class FunResourceTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/funResource/", port);
    ...
    public void a_add() {
    	...
    	funResource.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), funResource, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	FunResource userAttAppInfoVo = new FunResource();
    ...
    public void e_getpage() {
    	PageParameter<FunResource> pageParameter = new PageParameter<FunResource>();
