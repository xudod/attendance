package com.xudod.attendance.machine_user_relation;
...
public class MachineUserRelationTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/machineUserRelation/", port);
    ...
    @Test
    public void a_add() {
    	MachineUserRelation machineUserRelation = new MachineUserRelation();
    	machineUserRelation.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), machineUserRelation, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	MachineUserRelation userAttAppInfoVo = new MachineUserRelation();
    ...
    public void e_getpage() {
    	PageParameter<MachineUserRelation> pageParameter = new PageParameter<MachineUserRelation>();
