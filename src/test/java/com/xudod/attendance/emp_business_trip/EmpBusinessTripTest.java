package com.xudod.attendance.emp_business_trip;
...
public class EmpBusinessTripTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/empBusinessTrip/", port);
    ...
    @Test
    public void a_add() {
    	EmpBusinessTrip empBusinessTrip = new EmpBusinessTrip();
    	empBusinessTrip.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), empBusinessTrip, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	EmpBusinessTrip userAttAppInfoVo = new EmpBusinessTrip();
    ...
    public void e_getpage() {
    	PageParameter<EmpBusinessTrip> pageParameter = new PageParameter<EmpBusinessTrip>();
