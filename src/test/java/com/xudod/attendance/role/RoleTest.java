package com.xudod.attendance.role;
...
public class RoleTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/role/", port);
    ...
    public void a_add() {
    	...
    	role.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), role, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	Role userAttAppInfoVo = new Role();
    ...
    public void e_getpage() {
    	PageParameter<Role> pageParameter = new PageParameter<Role>();
