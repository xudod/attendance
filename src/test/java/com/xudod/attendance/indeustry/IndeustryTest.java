package com.xudod.attendance.indeustry;
...
public class IndeustryTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/indeustry/", port);
    ...
    @Test
    public void a_add() {
    	Indeustry indeustry = new Indeustry();
    	indeustry.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), indeustry, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	Indeustry userAttAppInfoVo = new Indeustry();
    ...
    public void e_getpage() {
    	PageParameter<Indeustry> pageParameter = new PageParameter<Indeustry>();
