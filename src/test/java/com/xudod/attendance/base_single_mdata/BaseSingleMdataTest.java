package com.xudod.attendance.base_single_mdata;
...
public class BaseSingleMdataTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/baseSingleMdata/", port);
    ...
    @Test
    public void a_add() {
    	BaseSingleMdata baseSingleMdata = new BaseSingleMdata();
    	baseSingleMdata.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), baseSingleMdata, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	BaseSingleMdata userAttAppInfoVo = new BaseSingleMdata();
    ...
    public void e_getpage() {
    	PageParameter<BaseSingleMdata> pageParameter = new PageParameter<BaseSingleMdata>();
