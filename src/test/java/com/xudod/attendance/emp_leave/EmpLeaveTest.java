package com.xudod.attendance.emp_leave;
...
public class EmpLeaveTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/empLeave/", port);
    ...
    public void a_add() {
    	...
    	empLeave.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), empLeave, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	EmpLeave userAttAppInfoVo = new EmpLeave();
    ...
    public void e_getpage() {
    	PageParameter<EmpLeave> pageParameter = new PageParameter<EmpLeave>();
