package com.xudod.attendance.machine_user_tem;
...
public class MachineUserTemTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/machineUserTem/", port);
    ...
    @Test
    public void a_add() {
    	MachineUserTem machineUserTem = new MachineUserTem();
    	machineUserTem.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), machineUserTem, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	MachineUserTem userAttAppInfoVo = new MachineUserTem();
    ...
    public void e_getpage() {
    	PageParameter<MachineUserTem> pageParameter = new PageParameter<MachineUserTem>();
