package com.xudod.attendance.user_schedule_change;
...
public class UserScheduleChangeTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/userScheduleChange/", port);
    ...
    @Test
    public void a_add() {
    	UserScheduleChange userScheduleChange = new UserScheduleChange();
    	userScheduleChange.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), userScheduleChange, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	UserScheduleChange userAttAppInfoVo = new UserScheduleChange();
    ...
    public void e_getpage() {
    	PageParameter<UserScheduleChange> pageParameter = new PageParameter<UserScheduleChange>();
