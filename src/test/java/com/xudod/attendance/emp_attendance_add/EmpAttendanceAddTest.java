package com.xudod.attendance.emp_attendance_add;
...
public class EmpAttendanceAddTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/empAttendanceAdd/", port);
    ...
    @Test
    public void a_add() {
    	EmpAttendanceAdd empAttendanceAdd = new EmpAttendanceAdd();
    	empAttendanceAdd.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), empAttendanceAdd, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	EmpAttendanceAdd userAttAppInfoVo = new EmpAttendanceAdd();
    ...
    public void e_getpage() {
    	PageParameter<EmpAttendanceAdd> pageParameter = new PageParameter<EmpAttendanceAdd>();
