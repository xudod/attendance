package com.xudod.attendance.user_schedule;
...
public class UserScheduleTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/userSchedule/", port);
    ...
    public void a_add() {
    	...
    	userSchedule.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), userSchedule, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	UserSchedule userAttAppInfoVo = new UserSchedule();
    ...
    public void e_getpage() {
    	PageParameter<UserSchedule> pageParameter = new PageParameter<UserSchedule>();
