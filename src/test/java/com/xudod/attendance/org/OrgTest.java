package com.xudod.attendance.org;
...
public class OrgTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/org/", port);
    ...
    public void a_add() {
    	...
    	org.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), org, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	Org userAttAppInfoVo = new Org();
    ...
    public void e_getpage() {
    	PageParameter<Org> pageParameter = new PageParameter<Org>();
