package com.xudod.attendance.all_punch_record;
...
public class AllPunchRecordTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/allPunchRecord/", port);
    ...
    @Test
    public void a_add() {
    	AllPunchRecord allPunchRecord = new AllPunchRecord();
    	allPunchRecord.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), allPunchRecord, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	AllPunchRecord userAttAppInfoVo = new AllPunchRecord();
    ...
    public void e_getpage() {
    	PageParameter<AllPunchRecord> pageParameter = new PageParameter<AllPunchRecord>();
