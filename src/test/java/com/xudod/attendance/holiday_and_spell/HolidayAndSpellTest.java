package com.xudod.attendance.holiday_and_spell;
...
public class HolidayAndSpellTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/holidayAndSpell/", port);
    ...
    @Test
    public void a_add() {
    	HolidayAndSpell holidayAndSpell = new HolidayAndSpell();
    	holidayAndSpell.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), holidayAndSpell, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	HolidayAndSpell userAttAppInfoVo = new HolidayAndSpell();
    ...
    public void e_getpage() {
    	PageParameter<HolidayAndSpell> pageParameter = new PageParameter<HolidayAndSpell>();
