package com.xudod.attendance.machine_info;
...
public class MachineInfoTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/machineInfo/", port);
    ...
    public void a_add() {
    	...
    	machineInfo.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), machineInfo, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	MachineInfo userAttAppInfoVo = new MachineInfo();
    ...
    public void e_getpage() {
    	PageParameter<MachineInfo> pageParameter = new PageParameter<MachineInfo>();
