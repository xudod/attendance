package com.xudod.attendance.app_sysinfo_mdata;
...
public class AppSysinfoMdataTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/appSysinfoMdata/", port);
    ...
    @Test
    public void a_add() {
    	AppSysinfoMdata appSysinfoMdata = new AppSysinfoMdata();
    	appSysinfoMdata.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), appSysinfoMdata, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	AppSysinfoMdata userAttAppInfoVo = new AppSysinfoMdata();
    ...
    public void e_getpage() {
    	PageParameter<AppSysinfoMdata> pageParameter = new PageParameter<AppSysinfoMdata>();
