package com.xudod.attendance.produce;
...
public class ProduceTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/produce/", port);
    ...
    public void a_add() {
    	...
    	produce.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), produce, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	Produce userAttAppInfoVo = new Produce();
    ...
    public void e_getpage() {
    	PageParameter<Produce> pageParameter = new PageParameter<Produce>();
