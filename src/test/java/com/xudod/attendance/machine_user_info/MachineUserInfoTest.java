package com.xudod.attendance.machine_user_info;
...
public class MachineUserInfoTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/machineUserInfo/", port);
    ...
    @Test
    public void a_add() {
    	MachineUserInfo machineUserInfo = new MachineUserInfo();
    	machineUserInfo.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), machineUserInfo, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	MachineUserInfo userAttAppInfoVo = new MachineUserInfo();
    ...
    public void e_getpage() {
    	PageParameter<MachineUserInfo> pageParameter = new PageParameter<MachineUserInfo>();
