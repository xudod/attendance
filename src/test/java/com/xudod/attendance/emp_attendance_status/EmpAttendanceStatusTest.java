package com.xudod.attendance.emp_attendance_status;
...
public class EmpAttendanceStatusTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/empAttendanceStatus/", port);
    ...
    @Test
    public void a_add() {
    	EmpAttendanceStatus empAttendanceStatus = new EmpAttendanceStatus();
    	empAttendanceStatus.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), empAttendanceStatus, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	EmpAttendanceStatus userAttAppInfoVo = new EmpAttendanceStatus();
    ...
    public void e_getpage() {
    	PageParameter<EmpAttendanceStatus> pageParameter = new PageParameter<EmpAttendanceStatus>();
