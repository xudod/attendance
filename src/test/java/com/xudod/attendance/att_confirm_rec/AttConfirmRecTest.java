package com.xudod.attendance.att_confirm_rec;
...
public class AttConfirmRecTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/attConfirmRec/", port);
    ...
    @Test
    public void a_add() {
    	AttConfirmRec attConfirmRec = new AttConfirmRec();
    	attConfirmRec.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), attConfirmRec, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	AttConfirmRec userAttAppInfoVo = new AttConfirmRec();
    ...
    public void e_getpage() {
    	PageParameter<AttConfirmRec> pageParameter = new PageParameter<AttConfirmRec>();
