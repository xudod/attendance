package com.xudod.attendance.org_produce_relation;
...
public class OrgProduceRelationTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/orgProduceRelation/", port);
    ...
    @Test
    public void a_add() {
    	OrgProduceRelation orgProduceRelation = new OrgProduceRelation();
    	orgProduceRelation.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), orgProduceRelation, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	OrgProduceRelation userAttAppInfoVo = new OrgProduceRelation();
    ...
    public void e_getpage() {
    	PageParameter<OrgProduceRelation> pageParameter = new PageParameter<OrgProduceRelation>();
