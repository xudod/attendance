package com.xudod.attendance.org_superior_relation;
...
public class OrgSuperiorRelationTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/orgSuperiorRelation/", port);
    ...
    @Test
    public void a_add() {
    	OrgSuperiorRelation orgSuperiorRelation = new OrgSuperiorRelation();
    	orgSuperiorRelation.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), orgSuperiorRelation, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	OrgSuperiorRelation userAttAppInfoVo = new OrgSuperiorRelation();
    ...
    public void e_getpage() {
    	PageParameter<OrgSuperiorRelation> pageParameter = new PageParameter<OrgSuperiorRelation>();
