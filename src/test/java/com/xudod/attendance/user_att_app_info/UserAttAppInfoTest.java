package com.xudod.attendance.user_att_app_info;
...
public class UserAttAppInfoTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/userAttAppInfo/", port);
    ...
    @Test
    public void a_add() {
    	UserAttAppInfo userAttAppInfo = new UserAttAppInfo();
    	userAttAppInfo.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), userAttAppInfo, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	UserAttAppInfo userAttAppInfoVo = new UserAttAppInfo();
    ...
    public void e_getpage() {
    	PageParameter<UserAttAppInfo> pageParameter = new PageParameter<UserAttAppInfo>();
