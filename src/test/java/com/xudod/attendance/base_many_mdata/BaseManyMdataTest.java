package com.xudod.attendance.base_many_mdata;
...
public class BaseManyMdataTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/baseManyMdata/", port);
    ...
    @Test
    public void a_add() {
    	BaseManyMdata baseManyMdata = new BaseManyMdata();
    	baseManyMdata.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), baseManyMdata, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	BaseManyMdata userAttAppInfoVo = new BaseManyMdata();
    ...
    public void e_getpage() {
    	PageParameter<BaseManyMdata> pageParameter = new PageParameter<BaseManyMdata>();
