package com.xudod.attendance.bpm_content_record;
...
public class BpmContentRecordTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/bpmContentRecord/", port);
    ...
    @Test
    public void a_add() {
    	BpmContentRecord bpmContentRecord = new BpmContentRecord();
    	bpmContentRecord.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), bpmContentRecord, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	BpmContentRecord userAttAppInfoVo = new BpmContentRecord();
    ...
    public void e_getpage() {
    	PageParameter<BpmContentRecord> pageParameter = new PageParameter<BpmContentRecord>();
