...
public class ScheduleCodeTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/scheduleCode/", port);
    ...
    public void a_add() {
    	...
    	scheduleCode.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), scheduleCode, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	ScheduleCode userAttAppInfoVo = new ScheduleCode();
    ...
    public void e_getpage() {
    	PageParameter<ScheduleCode> pageParameter = new PageParameter<ScheduleCode>();
