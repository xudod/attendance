package com.xudod.attendance.machine_user_face;
...
public class MachineUserFaceTest {
    ...
    public void setUp() throws Exception {
        String url = String.format("http://localhost:%d/machineUserFace/", port);
    ...
    @Test
    public void a_add() {
    	MachineUserFace machineUserFace = new MachineUserFace();
    	machineUserFace.setId(uuid);
    	// TODO
        ResponseEntity<BaseResp> response = template.postForEntity(base.toString(), machineUserFace, BaseResp.class);
        assertThat(response.getBody().getCode(), equalTo(0));
    }
    
    @Test
    public void b_upbykey() {
    	MachineUserFace userAttAppInfoVo = new MachineUserFace();
    ...
    public void e_getpage() {
    	PageParameter<MachineUserFace> pageParameter = new PageParameter<MachineUserFace>();
